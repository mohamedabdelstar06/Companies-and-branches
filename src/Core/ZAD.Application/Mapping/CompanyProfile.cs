    ...
    public class CompanyProfile : Profile
    {
        public CompanyProfile()
        {
            ...
            CreateMap<Company, CompanyListDto>()
                ...
                .ForMember(d => d.Website, opt => opt.MapFrom(s => s.Contacts.FirstOrDefault(c => c.Type == ContactType.Website) != null ? s.Contacts.FirstOrDefault(c => c.Type == ContactType.Website)!.Value : null))
                .ForMember(d => d.Phone, opt => opt.MapFrom(s => s.Contacts.FirstOrDefault(c => c.Type == ContactType.Phone) != null ? s.Contacts.FirstOrDefault(c => c.Type == ContactType.Phone)!.Value : null))
